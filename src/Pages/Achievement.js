  ...
  return (
    <div className="achievement-container">
      ...
      <div className="achievement-content">
        <h1 className="text-center pt-5  text-dark">
          Our <span className="bold">Achievements</span>
        </h1>
        <div className="text-center">
          <img src="https://rabsnetsolutions.com/experience-center/assets/img/RABS_Landing_Page/hero2.jpg" className="img-fluid" alt="Achievement" />
        </div>
        <h3 className="text-center my-4 pb-4 text-white">
          ("Received award from the Honorable Chief Minister of Goa and the Governor of Sikkim")
        </h3>
